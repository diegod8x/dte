 ...
 * DteDtesFixture
 */
class DteDtesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'dte_tipo_dte_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'fk_dte_dtes_dte_tipo_dtes1_idx' => ['type' => 'index', 'columns' => ['dte_tipo_dte_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'id_UNIQUE' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
            'fk_dte_dtes_dte_tipo_dtes1' => ['type' => 'foreign', 'columns' => ['dte_tipo_dte_id'], 'references' => ['dte_tipo_dtes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-08-06 04:22:01',
                'modified' => '2019-08-06 04:22:01'
            ],
        ];
        parent::init();
    }
